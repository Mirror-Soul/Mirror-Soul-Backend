...
public enum GeneralErrorCode implements BaseErrorCode {
    ...
    VALUE_BALANCE_ALREADY_ANSWERED(HttpStatus.CONFLICT, "VALUE_BALANCE_4090", "This question was already answered."),
    ...
    VALUE_BALANCE_SET_LOCKED(HttpStatus.TOO_MANY_REQUESTS, "VALUE_BALANCE_4291", "The next value balance set is still locked."),
    VALUE_BALANCE_COMPLETED(HttpStatus.CONFLICT, "VALUE_BALANCE_4091", "All value balance sets are completed."),
    VALUE_BALANCE_ANALYSIS_JOB_NOT_FOUND(HttpStatus.NOT_FOUND, "VALUE_BALANCE_4041", "Value balance analysis job not found."),
